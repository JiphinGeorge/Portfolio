const projects = [
  ...
  },
  {
    id: 3,
    url: 'xynapse',
    banner: '/projects/xynapse-placeholder.png',
    img: '/projects/xynapse-placeholder.png',
    title: 'Xynapse Mobile App',
    type: 'App',
    icon: '/jg-logo.png',
    github: 'https://github.com/JiphinGeorge/Xynapse-A-Collaboration-Platform_Hackathon',
    blog: '#',
    web: '#',
    description: 'An upcoming mobile application aimed at community engagement built in Flutter.',
    tags: [
      {name: 'Mobile App'},
    ],
    tech: [
