...
export default function TermsAndConditions() {
  return (
    <>
      <Head>
        <title>Terms and Conditions | Jiphin George</title>
      </Head>
      <TermsAndConditionsContainer>
        ...
        <p>Welcome to Jiphin George&apos;s Portfolio. By accessing or using this website, you agree to comply with and be bound by the following terms and conditions. If you do not agree with these terms, please do not use this site.</p>

        <h3>1. Acceptance of Terms</h3>
        <p>By using Jiphin George&apos;s Portfolio, you acknowledge that you have read, understood, and agree to these Terms and Conditions, along with the Privacy Policy.</p>
        ...
        <p>By using features like the contact form or feedback form, you agree to the collection and use of your data as outlined in our Privacy Policy.</p>

        <h3>6. Third-Party Services</h3>
        <p>This site uses third-party tools (such as Google Analytics, Vercel, Email.js, and others) to manage analytics, forms, and embeds. Each service is governed by its own privacy policy and terms.</p>
        ...
        <p>Jiphin George&apos;s Portfolio is provided &quot;as is,&quot; without warranties of any kind.</p>
        ...
        <p>Modifications made to the site by Jiphin George are for personal, non-commercial use only. Unauthorized use is prohibited outside the scope of personal use.</p>
